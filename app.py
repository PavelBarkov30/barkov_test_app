...
if app_mode == 'Разделение по полу':
    ...
    st.markdown(
        'Так как распределения значений в выборках не является нормальным, применим непараметрический  тест Манна-Уитни для сравнения двух независимых выборок.')
    ...
    age = st.slider('age', min_age, max_age)
